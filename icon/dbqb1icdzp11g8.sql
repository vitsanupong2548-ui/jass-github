...
--
-- Host: localhost
-- Generation Time: Mar 02, 2026 at 11:16 AM
...
CREATE TABLE `cmbigband` (
  ...
  `genre_th` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `courses` (
  ...
  `creator_th` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `details` text COLLATE utf8mb4_unicode_ci,
  `details_th` text COLLATE utf8mb4_unicode_ci,
  `banner_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 2, 'EN', 'ภาษาไทยได้แล้ววันนี้', 'ฟหกด', '', '[{\"type\":\"iframe\",\"value\":\"<iframe src=\\\"https:\\/\\/docs.google.com\\/document\\/d\\/e\\/2PACX-1vShOTFH03_gL6znQMKBenbEBSfb1jVj-l0Ir0ujQSssB_1fZcz9atGjfEW9CsFSvfyrKnKIeW-GgJTf\\/pub?embedded=true\\\"><\\/iframe>\",\"layout\":\"col-1\"}]', '[{\"type\":\"iframe\",\"value\":\"<iframe src=\\\"https:\\/\\/docs.google.com\\/document\\/d\\/e\\/2PACX-1vShOTFH03_gL6znQMKBenbEBSfb1jVj-l0Ir0ujQSssB_1fZcz9atGjfEW9CsFSvfyrKnKIeW-GgJTf\\/pub?embedded=true\\\"><\\/iframe>\",\"layout\":\"col-1\"}]', 'uploads/courses/course_banner_1771961875_699dfe139097c.jpg'),
(3, 3, 'asdf', '', 'adsf', '', '[{\"type\":\"text\",\"value\":\"asdf\",\"layout\":\"col-1\"},{\"type\":\"embed\",\"value\":\"https:\\/\\/www.facebook.com\\/share\\/r\\/1ENjxbd37D\\/\",\"layout\":\"col-1\"}]', '[{\"type\":\"text\",\"value\":\"\",\"layout\":\"col-1\"},{\"type\":\"embed\",\"value\":\"https:\\/\\/www.facebook.com\\/share\\/r\\/1ENjxbd37D\\/\",\"layout\":\"col-1\"}]', 'uploads/courses/course_banner_1771961912_699dfe38e15a4.jpg'),
(4, 5, 'ฟกหดฟหกด', NULL, 'ฟหกดฟหกด', NULL, '[{\"type\":\"text\",\"value\":\"ฟหกดฟหกด\"}]', NULL, 'uploads/courses/course_banner_1772004380_699ea41c56a30.jpg'),
(5, 1, 'สวัดดี', 'สวัดดีครับทุกคน', 'ฟหกด', '', '[{\"type\":\"text\",\"value\":\"ฟหกดฟ\",\"layout\":\"col-1\"}]', '[{\"type\":\"text\",\"value\":\"\",\"layout\":\"col-1\"}]', 'uploads/courses/course_banner_1772004418_699ea442eb4bf.jpg'),
(6, 6, '', '', '', '', '[{\"type\":\"text\",\"value\":\"\",\"layout\":\"col-1\"},{\"type\":\"embed\",\"value\":\"<div style=\\\"position: relative; width: 100%; height: 0; padding-top: 95.3125%;\\r\\n padding-bottom: 0; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16); margin-top: 1.6em; margin-bottom: 0.9em; overflow: hidden;\\r\\n border-radius: 8px; will-change: transform;\\\">\\r\\n  <iframe loading=\\\"lazy\\\" style=\\\"position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0;\\\"\\r\\n    src=\\\"https:\\/\\/www.canva.com\\/design\\/DAGzc6lWOsw\\/E0YSHsULwgB3V0ktbKDdXA\\/view?embed\\\" allowfullscreen=\\\"allowfullscreen\\\" allow=\\\"fullscreen\\\">\\r\\n  <\\/iframe>\\r\\n<\\/div>\\r\\n<a href=\\\"https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAGzc6lWOsw&#x2F;E0YSHsULwgB3V0ktbKDdXA&#x2F;view?utm_content=DAGzc6lWOsw&amp;utm_campaign=designshare&amp;utm_medium=embeds&amp;utm_source=link\\\" target=\\\"_blank\\\" rel=\\\"noopener\\\">Learn More<\\/a> by Old Chiangmai Cultural Center\",\"layout\":\"col-1\"}]', '[{\"type\":\"text\",\"value\":\"\",\"layout\":\"col-1\"},{\"type\":\"embed\",\"value\":\"<div style=\\\"position: relative; width: 100%; height: 0; padding-top: 95.3125%;\\r\\n padding-bottom: 0; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16); margin-top: 1.6em; margin-bottom: 0.9em; overflow: hidden;\\r\\n border-radius: 8px; will-change: transform;\\\">\\r\\n  <iframe loading=\\\"lazy\\\" style=\\\"position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0;\\\"\\r\\n    src=\\\"https:\\/\\/www.canva.com\\/design\\/DAGzc6lWOsw\\/E0YSHsULwgB3V0ktbKDdXA\\/view?embed\\\" allowfullscreen=\\\"allowfullscreen\\\" allow=\\\"fullscreen\\\">\\r\\n  <\\/iframe>\\r\\n<\\/div>\\r\\n<a href=\\\"https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAGzc6lWOsw&#x2F;E0YSHsULwgB3V0ktbKDdXA&#x2F;view?utm_content=DAGzc6lWOsw&amp;utm_campaign=designshare&amp;utm_medium=embeds&amp;utm_source=link\\\" target=\\\"_blank\\\" rel=\\\"noopener\\\">Learn More<\\/a> by Old Chiangmai Cultural Center\",\"layout\":\"col-1\"}]', NULL);
...
INSERT INTO `course_reviews` (`id`, `reviewer_name`, `rating`, `review_text`, `created_at`) VALUES
(2, 'TEST', 5, 'TESTTESTTEST', '2026-02-27 19:37:49'),
(3, 'TEST', 5, 'TESTTESTTESTTEST', '2026-02-27 19:37:52'),
(4, 'TEST', 5, 'TESTTESTTESTTESTTEST', '2026-02-27 19:37:56'),
(5, 'TEST', 5, 'TESTTESTTESTTESTTESTTEST', '2026-02-27 19:38:08'),
(6, 'TEST', 5, '', '2026-02-27 19:38:16');
...
CREATE TABLE `events` (
  ...
  `short_description_th` text COLLATE utf8mb4_unicode_ci,
  ...
  `venue_title_th` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `venue_details` text COLLATE utf8mb4_unicode_ci,
  `venue_details_th` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `event_bookings` (
  `id` int NOT NULL,
  `booking_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'รหัสการจอง เช่น #TK1001',
  `user_id` int DEFAULT NULL COMMENT 'ID ของ User ที่ล็อคอิน (ถ้ามี)',
  `event_id` int NOT NULL COMMENT 'จองของงานเทศกาลไหน',
  ...
  `slip_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'รูปสลิปโอนเงิน',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(131, 16, '2025-12-07', '17:30:00', 'OLD CHIANGMAI CULTURAL CENTER', 'Chiang mai Big Band', '2026-03-01 18:16:44'),
(132, 16, '2025-12-07', '19:00:00', 'OLD CHIANGMAI CULTURAL CENTER', 'Rossy Rose Carniel Trio', '2026-03-01 18:16:44'),
(133, 16, '2025-12-07', '20:20:00', 'OLD CHIANGMAI CULTURAL CENTER', 'Yoh Duck Quartet Feat. Krit Buranavitayawut', '2026-03-01 18:16:44'),
(134, 16, '2025-12-07', '21:40:00', 'OLD CHIANGMAI CULTURAL CENTER', 'Gen-Z Quartet', '2026-03-01 18:16:44'),
(135, 16, '2025-12-07', '23:00:00', 'OLD CHIANGMAI CULTURAL CENTER', 'Groovy Doopy x Rachael', '2026-03-01 18:16:44'),
(140, 13, '2026-02-08', '18:00:00', 'Melia Chiang Mai Hotel — Yi Peng Grand Ballroom', 'Doors Open Arrive early for cocktails, canapes, and conversation with fellow jazz lovers in an elegant ballroom setting.', '2026-03-02 11:12:08'),
(141, 13, '2026-02-08', '19:00:00', 'Melia Chiang Mai Hotel — Yi Peng Grand Ballroom', 'First Set', '2026-03-02 11:12:08'),
(142, 13, '2026-02-08', '19:45:00', 'Melia Chiang Mai Hotel — Yi Peng Grand Ballroom', 'Intermission & Open Bar', '2026-03-02 11:12:08'),
(143, 13, '2026-02-08', '20:15:00', 'Melia Chiang Mai Hotel — Yi Peng Grand Ballroom', 'Second Set', '2026-03-02 11:12:08');
...
(101, 16, 'test', 'te', 20.00, 1, 1),
(103, 13, 'Adult Ticket', '', 850.00, 160, 0);
...
INSERT INTO `forum_categories` (`id`, `name_en`, `name_th`) VALUES
(1, 'General Discussion', 'พูดคุยทั่วไป'),
(2, 'Instruments & Gear', 'เครื่องดนตรีและอุปกรณ์'),
(3, 'Find Band Members', 'หาสมาชิกวง/หาเพื่อนเล่นดนตรี'),
(4, 'Events & Reviews', 'รีวิวงานและร้านแจ๊ส');
...
INSERT INTO `forum_comments` (`id`, `topic_id`, `user_id`, `comment_text`, `image_url`, `created_at`, `likes`) VALUES
(2, 23, 1, 'wow', NULL, '2026-02-27 19:13:46', 1),
(3, 23, 1, 'wow', NULL, '2026-02-27 19:14:01', 0),
(4, 23, 1, 'wow', NULL, '2026-02-27 19:14:09', 0),
(5, 24, 1, 'wow', NULL, '2026-02-27 21:06:33', 2),
(6, 24, 1, 'wow', NULL, '2026-02-27 22:30:59', 0),
(7, 24, 1, 'wow', NULL, '2026-02-27 22:31:02', 0),
(8, 24, 1, 'wow', NULL, '2026-02-27 22:31:03', 1),
(9, 24, 1, 'wow', NULL, '2026-02-27 22:31:04', 0),
(10, 24, 1, 'wow', NULL, '2026-02-27 22:31:04', 1),
(11, 24, 1, 'wow', NULL, '2026-02-27 22:31:04', 0),
(12, 24, 1, 'wow', NULL, '2026-02-27 22:31:09', 0),
(13, 24, 1, 'wow', NULL, '2026-02-27 22:31:10', 0),
(14, 24, 1, 'wow', NULL, '2026-02-27 22:31:10', 0),
(15, 24, 1, 'wow', NULL, '2026-02-27 22:31:38', 0),
(16, 24, 1, 'wow', NULL, '2026-02-27 22:31:38', 0),
(17, 24, 1, 'wow', NULL, '2026-02-27 22:31:38', 0),
(18, 24, 1, 'wow', NULL, '2026-02-27 22:31:39', 0),
(19, 24, 1, 'wow', NULL, '2026-02-27 22:31:39', 0),
(20, 24, 1, 'wow', NULL, '2026-02-27 22:31:39', 0),
(21, 24, 1, 'wow', NULL, '2026-02-27 22:31:39', 0);
...
CREATE TABLE `orders` (
  ...
  `order_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'รหัสออเดอร์ เช่น #25364',
  `customer_name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อลูกค้า',
  `address` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ที่อยู่จัดส่ง',
  `phone` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'เบอร์โทรศัพท์',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'อีเมลลูกค้า',
  `payment_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'สถานะการชำระเงิน',
  `order_status` enum('pending','success','canceled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'สถานะคำสั่งซื้อ',
...
(4, 'ST-20260301-1597', 'ำไๆำๆ ำๆำๆ', 'ewq จ.ewqeq รหัสไปรษณีย์ 22', '999999', 'poolre123@gmail.com', '', 'canceled', '2026-03-01 13:43:46'),
(5, 'ST-20260301-9159', 'ำไๆำๆ ำๆำๆ', 'ewq จ.ewqeq รหัสไปรษณีย์ 22', '999999', 'poolre123@gmail.com', '', 'pending', '2026-03-01 13:46:08'),
(6, 'ST-20260301-8189', 'ำไๆำๆ ำๆำๆ', 'ewq จ.ewqeq รหัสไปรษณีย์ 22', '999999', 'poolre123@gmail.com', '', 'pending', '2026-03-01 13:50:34'),
(7, 'ST-20260301-5422', 'ำไๆำๆ ำๆำๆ', 'ewq จ.ewqeq รหัสไปรษณีย์ 22', '999999', 'poolre123@gmail.com', '', 'pending', '2026-03-01 14:57:20'),
(8, 'ST-20260301-2368', 'ำไๆำๆ ำๆำๆ', 'ewq (ชำระผ่าน: QR PromptPay) จ.ewqeq รหัสไปรษณีย์ 22', '999999', 'poolre123@gmail.com', 'uploads/slips/slip_store_1772379762_3203.png', 'success', '2026-03-01 15:42:42'),
(9, 'ST-20260301-7258', 'ำไๆำๆ ำๆำๆ', 'ewq (ชำระผ่าน: QR PromptPay) จ.ewqeq รหัสไปรษณีย์ 22', '999999', 'poolre123@gmail.com', 'uploads/slips/slip_store_1772382846_2828.png', 'success', '2026-03-01 16:34:06'),
(10, 'ST-20260302-2411', 't ewqeq', 'we จ.55 รหัสไปรษณีย์ 5', '999999', 'poolre123@gmail.com', 'uploads/slips/slip_store_1772443729_9699.webp', 'pending', '2026-03-02 09:28:49');
...
CREATE TABLE `order_items` (
  ...
  `order_id` int NOT NULL COMMENT 'อ้างอิงรหัสคำสั่งซื้อ',
  `product_id` int NOT NULL COMMENT 'อ้างอิงรหัสสินค้า',
  `quantity` int NOT NULL DEFAULT '1' COMMENT 'จำนวนชิ้นที่สั่ง (Amount)',
...
CREATE TABLE `products` (
  ...
  `product_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'รหัสสินค้า เช่น HKL001',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อสินค้า',
  `price` decimal(10,2) NOT NULL COMMENT 'ราคาสินค้า',
  `stock_balance` int NOT NULL DEFAULT '0' COMMENT 'จำนวนสินค้าคงเหลือ (Stock)',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT 'รายละเอียดสินค้า',
  `image_products` text COLLATE utf8mb4_unicode_ci COMMENT 'พาร์ท/URL ของรูปภาพสินค้าทั้งหมด (เก็บเป็น JSON String)',
  `image_banner` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'พาร์ท/URL ของรูป Banner',
  `sale_status` enum('open','close') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open' COMMENT 'สถานะการขาย (เปิด/ปิด)',
...
(2, 'HKL002', 'แก้วมัค CMBigband', 150.00, 17, 'แก้วเซรามิกเก็บความร้อน', '[]', NULL, 'open', '2026-02-28 17:21:14', '2026-03-01 13:46:08'),
(5, 'HKL69a357cbc4d9d', 'rrrrrrrrr', 88000.00, 47, 'tyutyuytuytu', '[]', NULL, 'open', '2026-02-28 21:02:03', '2026-03-01 16:34:06'),
(6, 'HKL69a357da3ca99', 'werwerwer', 85005.00, 299, 'erwerwtrwer', '[]', NULL, 'open', '2026-02-28 21:02:18', '2026-03-01 14:57:20'),
(7, 'HKL69a357e269592', 'asdfasdfs', 8000.00, 45, 'asdfasdfasdfds', '[]', 'uploads/store/banner_HKL69a357e269592_69a5712d2c24b.webp', 'open', '2026-02-28 21:02:26', '2026-03-02 11:15:03');
...
CREATE TABLE `ticket_orders` (
  `order_id` int NOT NULL,
  `order_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'รหัสออเดอร์ เช่น #T25364',
  `event_id` int NOT NULL COMMENT 'อ้างอิงรหัสงานอีเวนต์ (ตาราง events)',
  `ticket_id` int NOT NULL COMMENT 'อ้างอิงรหัสประเภทตั๋ว (ตาราง event_tickets)',
  `customer_name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อ-นามสกุลลูกค้า',
  `address` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ที่อยู่จัดส่งเอกสาร/ข้อมูล',
  `phone` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'เบอร์โทรศัพท์',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'อีเมลลูกค้า',
  `amount` int NOT NULL DEFAULT '1' COMMENT 'จำนวนตั๋วที่ซื้อ',
  `total_price` decimal(10,2) NOT NULL COMMENT 'ราคารวมทั้งหมด ณ ตอนที่ซื้อ',
  `payment_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'สถานะการชำระเงิน',
  `order_status` enum('pending','success','canceled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'สถานะคำสั่งซื้อ',
...
INSERT INTO `ticket_orders` (`order_id`, `order_code`, `event_id`, `ticket_id`, `customer_name`, `address`, `phone`, `email`, `amount`, `total_price`, `payment_status`, `order_status`, `created_at`) VALUES
(5, 'TK-20260301-1859-99', 14, 99, 't', '', '2', '', 1, 600.00, 'uploads/slips/slip_ticket_1772388421_69a4804587d69.png', 'canceled', '2026-03-01 18:07:01');
...
(8, 'Phurinat', '$2y$10$RPztrcCEq/LF0XYvkCtFi.gqO57j86v2cZ2B2o4wXUn.guHOVB.b6', 'poolpoolre123@gmail.com', 'user', '', '2026-03-01 18:24:16');
...
CREATE TABLE `user_profiles` (
  `id` int NOT NULL,
  `user_id` int NOT NULL,
  `saved_name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `saved_phone` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `saved_email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
